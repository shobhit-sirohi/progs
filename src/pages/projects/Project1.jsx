        ...
        <div className="grid grid-cols-1 h-fit md:grid-cols-6">
          <div className="flex flex-col col-span-3 gap-6">
            <h1 className="2xl:mt-20 text-3xl font-bold xl:leading-[5rem] xl:text-6xl lg:leading-[4rem] lg:text-4xl font-hiragino">
              ...
              <span className="text-[#F95FE7] inline-block xl:leading-[5rem] xl:text-6xl lg:leading-[4rem] lg:text-4xl">
                Portfolio&nbsp;
              </span>
              <span className="inline-block text-3xl xl:leading-[5rem] xl:text-6xl lg:leading-[4rem] lg:text-4xl">Project</span>
            </h1>
