        ...
        <div className="grid grid-cols-1 h-fit md:grid-cols-6">
          <div className="flex flex-col col-span-4 gap-6">
            <h1 className="top-mar lg:mt-5 xl:mt-10 2xl:mt-20 text-3xl lg:text-4xl xl:text-[45px] 2xl:text-[52px] font-bold xl:leading-[5rem] lg:leading-[4rem] font-hiragino">
              ...
              <span className="inline-block  xl:leading-[5rem] lg:leading-[4rem] l">The Human Way&nbsp;</span>
              <span className="inline-block  xl:leading-[5rem] lg:leading-[4rem] l">to Discover Food</span>
            </h1>
            <h2 className="text-lg font-semibold md:text-xl xl:text-2xl font-inter">Real food recommendations from real people.</h2>
            <p className="text-md lg:text-xl font-inter 2xl:mr-28">Crave is a food concierge app that helps users discover places to eat based on how they feel and where they are. Instead of scrolling through ratings and reviews, users connect with real food enthusiasts who offer personalized, mood-based suggestions, and can even join you for the meal. <br />This case study explores how Crave was designed to turn food discovery into a social, human-first experience.</p>
          </div>
